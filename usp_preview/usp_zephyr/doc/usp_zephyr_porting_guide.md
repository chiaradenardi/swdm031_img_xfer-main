...
In case the targeted MCU requires some modifications, please refer to the [USP Porting Guide - HAL Implementation](https://github.com/Lora-net/usp/blob/FLRC_BURST_2026-01-27_release/doc/usp_porting_guide.md).
