...
Please refer to `README.md`[LOCAL](../../modules/lib/usp/protocols/lbm_lib/README) [ONLINE](https://github.com/Lora-net/usp/blob/FLRC_BURST_2026-01-27_release/protocols/lbm_lib/README.md) to get all information related to LoRa Basics Modem library

## Radio Access Controller (RAC) API

- Documentation for the USP API is available in [LOCAL](../../modules/lib/usp/smtc_rac_lib/README.md) [ONLINE](https://github.com/Lora-net/usp/blob/FLRC_BURST_2026-01-27_release/smtc_rac_lib/README.md)
- API is avalable here : [LOCAL](../../modules/lib/usp/smtc_rac_lib/smtc_rac_api/smtc_rac_api.h) [ONLINE](https://github.com/Lora-net/usp/blob/FLRC_BURST_2026-01-27_release/smtc_rac_lib/smtc_rac_api/smtc_rac_api.h)
