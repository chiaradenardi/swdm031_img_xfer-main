...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TRANSMITTER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLRC_BURST_FIFO_IRQ_POLLING, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SEMTECH_LR2021_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SEMTECH_LR20XX_DIOS_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZEPHYR_XIAOSYNC_CAPTURE_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORA_BASICS_MODEM_DRIVERS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORA_BASICS_MODEM_DRIVERS_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORA_BASICS_MODEM_DRIVERS_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SEMTECH_LR20XX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LR20XX_HAL_SPI_BUFFER_MAX_LENGTH, 520);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORA_BASICS_MODEM_DRIVERS_INIT_PRIORITY, 50);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORA_BASICS_MODEM_DRIVERS_EVENT_TRIGGER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORA_BASICS_MODEM_DRIVERS_EVENT_TRIGGER_NO_THREAD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORA_BASICS_MODEM_DRIVERS_HAL_WAIT_ON_BUSY_TIMEOUT_MSEC, 600000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORA_BASICS_MODEM_DRIVERS_RAL_RALF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USP_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USP_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USP_MAIN_THREAD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USP_MAIN_THREAD_STACK_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USP_MAIN_THREAD_PRIORITY, -4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USP_MAIN_THREAD_MAX_SLEEP_MS, 60000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORA_BASICS_MODEM_PROVIDED_STORAGE_IMPL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_USP_ZEPHYR_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_USP_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_SEMTECH_WIO_LR2021, 1);
